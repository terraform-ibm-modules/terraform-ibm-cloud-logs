...
func TestRunFullyConfigurable(t *testing.T) {
	...
	var preReqDir = "./resources/prereq-cos-only"
...
func TestRunUpgradeConfigurableDA(t *testing.T) {
	t.Parallel()

	options := testhelper.TestOptionsDefault(&testhelper.TestOptions{
		Testing:      t,
		TerraformDir: configurableDADir,
		Prefix:       "icl-da-upg",
	})
...
func TestSecureDAInSchematics(t *testing.T) {
	t.Parallel()
	...
	if existErr != nil {
		...
		options.TerraformVars = []testschematic.TestSchematicTerraformVar{
			...
			{Name: "existing_event_notifications_instances", Value: terraform.Output(t, existingTerraformOptions, "en_crns"), DataType: "list(string)"},
		}
