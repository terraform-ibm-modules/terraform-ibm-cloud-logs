...
| <a name="input_en_endpoint_type"></a> [en\_endpoint\_type](#input\_en\_endpoint\_type) | The endpoint type of integration. Allowed values: private and public. | `string` | n/a | yes |
