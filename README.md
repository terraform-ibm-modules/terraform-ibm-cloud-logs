...
| <a name="module_cos_bucket_crn_parser"></a> [cos\_bucket\_crn\_parser](#module\_cos\_bucket\_crn\_parser) | terraform-ibm-modules/common-utilities/ibm//modules/crn-parser | 1.4.1 |
...
| <a name="input_cloud_logs_endpoint_type"></a> [cloud\_logs\_endpoint\_type](#input\_cloud\_logs\_endpoint\_type) | The Cloud Logs instance endpoint type. Allowed values `public` and `private`. | `string` | `"public"` | no |
...
| <a name="input_en_integration_endpoint_type"></a> [en\_integration\_endpoint\_type](#input\_en\_integration\_endpoint\_type) | The Event Notifications instance endpoint type for cloud logs integration. Allowed values: `private` and `public`. Default is `public`. | `string` | `"public"` | no |
