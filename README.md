...
| <a name="input_plan"></a> [plan](#input\_plan) | The IBM Cloud Logs plan to provision. Available: standard, standard-plus-metrics, lite. Note: standard-plus-metrics is not a GAed plan. | `string` | `"standard"` | no |
