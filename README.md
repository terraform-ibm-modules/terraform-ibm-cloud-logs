...
| <a name="input_en_integration_endpoint_type"></a> [en\_integration\_endpoint\_type](#input\_en\_integration\_endpoint\_type) | The endpoint type of integration. Allowed values: private and public. Default is public | `string` | `"public"` | no |
