...
| <a name="module_parsing_rules"></a> [parsing\_rules](#module\_parsing\_rules) | ./modules/parsing_rules | n/a |
...
| <a name="input_parsing_rules_endpoint_type"></a> [parsing\_rules\_endpoint\_type](#input\_parsing\_rules\_endpoint\_type) | The endpoint type to use to communicate with the IBM Cloud Logs instance when creating parsing rules. Allowed values: public, private. | `string` | `"public"` | no |
